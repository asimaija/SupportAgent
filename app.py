...
if not st.session_state.customer_logged_in:
    ...
    # =====================================================
        ...
        st.caption(
            "Login to access Chat Support and Check Status."
        )
...
# =========================================================
    ...
    # IMPORTANT:
    # Complaint registration page has been removed.
    # Customers can register complaints only through Chat Support.
        ...
        if question:
            ...
            if st.session_state.waiting_for_complaint:
                ...
                try:
                    ...
                    # Complaint has now been registered.
                    st.session_state.waiting_for_complaint = False
                    ...
                    # CURRENT RESPONSE
                    # -----------------------------------------
                    # This is currently generated by Python.
